...
NUM_CLASSES = 100
NUM_SAMPLES = {"train": 6667, "val": 3333}


@add_dts
class FGVCAircraft(ImageFolder, DefDataset):
    """
    FGVC Aircraft dataset wrapper.
