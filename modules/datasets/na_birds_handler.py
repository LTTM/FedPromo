...
NUM_CLASSES = 555 #743
NUM_SAMPLES = {"train": 23929, "val": 24633}


@add_dts
class NABirds(ImageFolder, DefDataset):
    """
    NABirds dataset wrapper.
