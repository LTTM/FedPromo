...
__all__ = ["ImageNetPets"]


# Constants
SUPPORTED_SPLITS = ["train", "val"]
NUM_CLASSES = 16
NUM_SAMPLES = {"train": 156973, "val": 6202}


@add_dts
class ImageNetPets(ImageFolder, DefDataset):
    """
    ImageNetPets dataset wrapper.
    This class contains a subset of the ImageNet dataset
    containing only the images of pets (cats and dogs).
    Each class correspond to a macrocategory of dogs or cats.
