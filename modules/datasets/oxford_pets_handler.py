...
NUM_CLASSES = 37
NUM_SAMPLES = {"train": 3680, "val": 3669}


@add_dts
class OxfordPets(ImageFolder, DefDataset):
    """
    OxfordPets dataset wrapper.
