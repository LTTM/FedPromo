"""
Module to handle the MilitaryAircraft dataset.
...
Classes:
    MilitaryAircraft: MilitaryAircraft dataset wrapper.
...
__all__ = ["MilitaryAircraft"]


# Constants
SUPPORTED_SPLITS = ["train", "val"]
NUM_CLASSES = 80
NUM_SAMPLES = {"train": 14369, "val": 4845}


@add_dts
class MilitaryAircraft(ImageFolder, DefDataset):
    """
    MilitaryAircraft dataset wrapper.
